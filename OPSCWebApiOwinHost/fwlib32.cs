...
namespace JNRSWebApiOwinHost
{
    ...
    public class ODBMDIP
    {
        ...
        public class ODBPDFADIR
        {
            ...
            public string d_f = new string(' ', 200);      /* path name */
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 40000)]
            public string comment = new string(' ', 400);  /* comment */
            [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 10000)]
            public string o_time = new string(' ', 100);   /* machining time stamp */
        }
    ...
    public class REALPRMS
    {
        ...
        public class ALM_HIS5
        {
            ...
            //public ALM_HIS5_data data11 = new ALM_HIS5_data();
            //public ALM_HIS5_data data12 = new ALM_HIS5_data();
            //public ALM_HIS5_data data13 = new ALM_HIS5_data();
            //public ALM_HIS5_data data14 = new ALM_HIS5_data();
            //public ALM_HIS5_data data15 = new ALM_HIS5_data();
            //public ALM_HIS5_data data16 = new ALM_HIS5_data();
            //public ALM_HIS5_data data17 = new ALM_HIS5_data();
            //public ALM_HIS5_data data18 = new ALM_HIS5_data();
            //public ALM_HIS5_data data19 = new ALM_HIS5_data();
            //public ALM_HIS5_data data20 = new ALM_HIS5_data();
        } /* In case that the number of data is 10 */
        [StructLayout(LayoutKind.Sequential, Pack = 4)]
